 ...
 */
it('verifies docker_compose_raw does not contain Publify labels after parsing', function () {
...
YAML;
    ...
    // Check that docker_compose_raw does NOT contain Publify labels
    ...
    // docker_compose_raw should NOT have Publify additions
