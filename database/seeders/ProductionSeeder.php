            ...
            if (! $found) {
                if ($coolify_key) {
                    ...
                    PrivateKey::create([
                        ...
                        'description' => 'The private key for the Publify host machine (localhost).',
                        'private_key' => $coolify_key,
                    ]);
                    $server->update(['user' => $user]);
                    echo "SSH key found for the Publify host machine (localhost).\n";
                } else {
                    echo "No SSH key found for the Publify host machine (localhost).\n";
