...
class DeploymentSuccess extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        if ($pull_request_id === 0) {
            $mail->subject("Publify: New version is deployed of {$this->application_name}");
        } else {
            $fqdn = $this->preview->fqdn;
            $mail->subject("Publify: Pull request #{$pull_request_id} of {$this->application_name} deployed successfully");
        }
