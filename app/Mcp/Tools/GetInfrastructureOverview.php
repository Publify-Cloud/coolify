...
class GetInfrastructureOverview extends Tool
{
    ...
    protected string $description = 'High-level overview of the authenticated team: Publify version, all servers, projects with resource counts, and aggregate counts. Start here to understand the setup.';
