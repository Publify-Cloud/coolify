...
class CleanupDocker
{
    ...
    public function handle(Server $server, bool $deleteUnusedVolumes = false, bool $deleteUnusedNetworks = false)
    {
        ...
        // Build image prune command that excludes application images and current Publify infrastructure images
        // This ensures we clean up non-Publify images while preserving rollback images and current helper/realtime images
    ...
    private function buildImagePruneCommand(
        ...
        // Build grep pattern to exclude Publify infrastructure images (current version only)
        ...
        // - Are not current Publify infrastructure images (any registry)
