    ...
    <div class="flex pt-6 pb-4 pl-2">
        <div class="flex flex-col w-full">
            <div class="text-2xl font-bold tracking-wide">
                <img src="/publify-logo-horizontal-dark.png" alt="Publify Logo" class="visible w-[250px] h-auto dark:hidden dark:w-0 dark:h-0">
                <img src="/publify-logo-horizontal-light.png" alt="Publify Logo" class="hidden dark:visible dark:block dark:w-[250px] dark:h-auto">
            </div>
            <x-version />
        </div>
        <div class="pt-1">
