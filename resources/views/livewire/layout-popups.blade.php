                ...
                if (window.Echo) {
                    if (window.Echo.connector.pusher.connection.state === 'connected') {
                        ...
                        if (checkNumber > 5) {
                            ...
                            console.error(
                                'Publify could not connect to its real-time service. This will cause unusual problems on the UI if not fixed! Please check the related documentation (https://coolify.io/docs/knowledge-base/cloudflare/tunnels/overview) or get help on Discord (https://coollabs.io/discord).)'
                            );
                        }
                ...
                <x-slot:customActions>
                    <div
                        ...
                        <div class="flex flex-col gap-2 lg:px-10 px-1">
                            <div class="lg:text-xl text-md dark:text-white font-bold">Love Publify? Support our work.
                            </div>
