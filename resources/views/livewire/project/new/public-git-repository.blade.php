            ...
            <div class="flex flex-col gap-2">
                ...
                <div>
                    For example application deployments, checkout <a class="underline dark:text-white"
                        href="https://github.com/coollabsio/coolify-examples/" target="_blank">Publify
                        Examples</a>.
                </div>
                @if ($branchFound)
                    ...
                    <div class="flex flex-col gap-2 pb-6">
                        ...
                        @endif
                        {{-- <div class="w-64">
                            <x-forms.checkbox helper="If your repository contains a publify.json file, it will be used to configure your application." instantSave id="checkCoolifyConfig" label="Use publify.json if exists?" />
                        </div> --}}
