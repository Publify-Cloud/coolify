    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('upgradeModal', () => ({
                ...
                checkHealthInterval = setInterval(() => {
                    fetch('/api/health')
                        .then(response => {
                            if (response.ok) {
                                this.currentStatus =
                                    'Publify is back online. Reloading this page (you can manually reload if its not done automatically)...';
                                ...
                                this.currentStatus =
                                    "Waiting for Publify to come back from the dead..."
                            }
                        })
                }, 2000);
            },
            upgrade() {
                ...
                this.currentStatus = 'Pulling new images and updating Publify.';
                    ...
                    fetch('/api/health')
                        .then(response => {
                            if (response.ok) {
                                ...
                                this.currentStatus =
                                    "Update done, restarting Publify & waiting until it is revived!"
