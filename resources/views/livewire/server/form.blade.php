        ...
        <div class="flex gap-2">
            ...
            @if ($server->id === 0)
                <x-modal-confirmation title="Confirm Server Settings Change?" buttonTitle="Save" submitAction="submit"
                    :actions="[
                        'You could lose a lot of functionalities if you change the server details of the server where Publify is running on.',
                        ...
                        <div class="w-64">
                            <x-forms.checkbox
                                ...
                                <ul class='list-disc pl-4 mt-2'>
                                    <li>Removes stopped containers manged by Publify (as containers are none persistent, no data will be lost).</li>
