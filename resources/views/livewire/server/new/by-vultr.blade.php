        ...
        @if ($current_step === 1)
            <div class="flex flex-col w-full gap-4">
                <div class="text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    <span class="text-xs">Publify's affiliate link - it supports both of us.</span>
                </div>
                ...
                <div class="flex flex-col gap-4 rounded-lg border border-error bg-error/10 p-4">
                    <div>
                        ...
                        <p class="text-sm text-neutral-700 dark:text-neutral-300">
                            Publify could not fetch Vultr data with the selected token. The token may have been
                        ...
                        <div class="flex w-full flex-col gap-4 p-3">
                            <div>
                                <x-forms.datalist label="Additional SSH Keys (from Vultr)" id="selectedVultrSshKeyIds"
                                    helper="Select existing SSH keys from your Vultr account to add to this server. The Publify SSH key will be automatically added."
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <x-forms.textarea id="cloud_init_script" label=""
                                    helper="Add a cloud-init script to run when the server is created. Publify sends it to Vultr as user data."
                                    rows="8" />
