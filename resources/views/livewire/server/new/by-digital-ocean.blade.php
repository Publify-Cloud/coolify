        ...
        @if ($current_step === 1)
            <div class="flex flex-col w-full gap-4">
                <div class="text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    <span class="text-xs">Publify's referral link - it supports both of us.</span>
                </div>
                ...
                <div class="flex flex-col gap-4 rounded-lg border border-error bg-error/10 p-4">
                    <div>
                        ...
                        <p class="text-sm text-neutral-700 dark:text-neutral-300">
                            Publify could not fetch DigitalOcean data with the selected token. The token may have been
                        ...
                        <div class="flex w-full flex-col gap-4 p-3">
                            <div>
                                <x-forms.datalist label="Extra SSH Keys" id="selectedDigitalOceanSshKeyIds"
                                    helper="Select existing SSH keys from your DigitalOcean account to add to this Droplet. The Publify SSH key will be automatically added."
