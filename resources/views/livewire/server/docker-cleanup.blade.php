<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Docker Cleanup | Publify
    </x-slot>
                ...
                @if (!isCloud() && $this->isCleanupStale)
                    <div class="mb-4">
                        <x-callout type="warning" title="Docker Cleanup May Be Stalled">
                            ...
                            @endif
                            <p class="mt-2">To resolve, run on your Publify instance:
                    ...
                    <div class="w-full sm:w-96">
                        <x-forms.checkbox canGate="update" :canResource="$server"
                            ...
                            <ul class='list-disc pl-4 mt-2'>
                                <li>Removes stopped containers managed by Publify (as containers are non-persistent, no data will be lost).</li>
