<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Advanced | Publify
    </x-slot>
                ...
                <div class="space-y-4">
                    <div class="text-sm">
                        ...
                        <ul class="list-disc pl-5 space-y-1">
                            <li>Mount this CA certificate of Publify into all containers that need to connect to one of your databases over SSL. You can see and copy the bind mount below.</li>
