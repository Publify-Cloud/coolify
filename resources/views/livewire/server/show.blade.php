<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > General | Publify
    </x-slot>
                ...
                <form wire:submit.prevent='submit'>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        @if ($server->isSentinelEnabled())
                            ...
                            <x-forms.input id="sentinelCustomUrl" required label="Publify URL"
                                helper="URL to your Publify instance. If it is empty that means you do not have a FQDN set for your Publify instance." />
