<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for Publify instance.</div>
        <div>
            ...
            @else
                To configure automatic backup for your Publify instance, you first need to add a database resource
                into Publify.
