    ...
    <div
        ...
        @elseif ($currentState === 'explanation')
            <x-boarding-step title="What is Publify?">
                <x-slot:question>
                    Publify is an all-in-one application to automate tasks on your servers, deploy applications with
                    Git
                ...
                <x-slot:explanation>
                    ...
                    <p>
                        ...
                        everything works without a connection to Publify (except integrations and automations).
                    </p>
                    <p>
        ...
        @elseif ($currentState === 'select-server-type')
            <x-boarding-step title="Server">
                ...
                <x-slot:explanation>
                    ...
                    <p>
                        <x-highlighted text="Localhost" /> is the server where Publify is running on. It is not
